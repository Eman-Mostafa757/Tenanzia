    ...
    public partial class AddEmailVerification : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskCommentReads", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskCommentReads_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskCommentReads_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskCommentReads_TaskId",
                table: "TaskCommentReads",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskCommentReads_UserId",
                table: "TaskCommentReads",
                column: "UserId");
